...
% 1509182
theta=[5/6*pi 8/9*pi pi -8/9*pi -13/18*pi -3/4*pi 1/3*pi 1/12*pi 0 -1/4*pi -1/3*pi -1/2*pi -4/9*pi -7/24*pi -1/4*pi -1/6*pi 1/9*pi 1/4*pi 1/3*pi 4/9*pi 13/24*pi 11/18*pi 2/3*pi 1/2*pi pi 7/12*pi 4/9*pi 7/12*pi 1/2*pi 1/2*pi];
